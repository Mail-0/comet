//! Syntax-highlighting contracts shared by Keiki's desktop surfaces.
//!
...
fn rust_configuration() -> Result<HighlightConfiguration, HighlightError> {
    ...
    // `constant.builtin`. Keiki preserves those structural roles separately.
