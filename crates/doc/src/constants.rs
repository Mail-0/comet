...
/// The local document folds its update log into the snapshot at this size.
...
/// Local document update-log flush cadence (ms).
...
/// Number of trailing messages materialized into the compact tail.
