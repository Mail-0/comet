//! Loader motion retained from the upstream Comet presentation layer.
//!
//! Each utility is a pure function of a phase in `0..1`, so future GPUI
//! surfaces can drive it from frame deltas or wall-clock time.
...
/// Per-row tints of the gradient matrix spinner.
